...
defbindings("WScreen", {
    ...
    kpress(META.."parenright", "WScreen.switch_next(_)"),
...
defbindings("WClientWin", {
    ...
    kpress(ALTMETA.."A", "WClientWin.quote_next(_)"),
})
...
defbindings("WGroupCW", {
    ...
    kpress_wait(META.."A", "WGroup.set_fullscreen(_, 'toggle')"),
})
...
defbindings("WMPlex.toplevel", {
    ...
    kpress(META.."exclam", "notioncore.show_live_docs(_)"),

    bdoc("Query for manual page to be displayed.", "man"),
    kpress(ALTMETA.."exclam", "mod_query.query_man(_, ':man')"),
})
...
defbindings("WFrame.toplevel", {
    ...
    kpress(META.."Q", "WFrame.switch_nth(_, 0)"),
    ...
    kpress(META.."period", "WFrame.dec_index(_, _sub)", "_sub:non-nil"),
    bdoc("Move current tab to the left within the frame.", "tab<-"),
    kpress(META.."slash", "WFrame.inc_index(_, _sub)", "_sub:non-nil"),
